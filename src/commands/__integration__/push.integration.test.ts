...
describe('push integration', () => {
  ...
  it('should throw NotInWorkspaceError when cwd is outside dest', async () => {
    ...
    await expect(runPush(integration.services)).rejects.toThrow(NotInWorkspaceError);
  });
